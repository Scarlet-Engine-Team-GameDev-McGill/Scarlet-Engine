...
// constexpr CRC32 taken from https://stackoverflow.com/questions/2111667/compile-time-string-hashing

namespace ScarletEngine::Utils
{
    // CRC32 Table (from zlib polynomial make_table)
...
#define COMPILE_TIME_CRC32_STR(x) (ScarletEngine::Utils::Crc32<sizeof(x) - 2>(x) ^ 0xFFFFFFFF)
