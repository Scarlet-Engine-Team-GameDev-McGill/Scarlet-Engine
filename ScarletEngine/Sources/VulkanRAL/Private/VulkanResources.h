...
namespace ScarletEngine
{
	...
	{
	public:
		VulkanGpuBuffer(VkPhysicalDevice PhysicalDevice, VkDevice LogicalDevice, uint32_t InSize, RALBufferUsage InUsage);
	...
	{
	public:
		VulkanShaderProgram(RALShader* InVertexShader, RALShader* InPixelShader, RALShader* InGeometryShader, RALShader* InComputeShader);
