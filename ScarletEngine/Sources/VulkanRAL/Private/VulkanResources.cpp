...
{
    VulkanGpuBuffer::VulkanGpuBuffer(VkPhysicalDevice InPhysicalDevice, VkDevice InLogicalDevice, uint32_t InSize, RALBufferUsage InUsage)
		...
		, LogicalDevice(InLogicalDevice)
    {
        ...
        switch (Usage)
        {
        	...
        	case RALBufferUsage::DYNAMIC_DRAW:
        		BufferCreateInfo.usage = VK_BUFFER_USAGE_VERTEX_BUFFER_BIT; // todo (vkRAL): this is not exactly correct but will suffice for now
        		break;
        	default:
        		break;
        }
