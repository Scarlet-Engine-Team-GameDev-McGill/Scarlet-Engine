...
namespace ScarletEngine
{
    ...
    void EditorViewportPanel::Construct()
    {
        ...
        EngineDelegates::OnWorldChanged.BindMember(this, &EditorViewportPanel::OnWorldChange);
    ...
    void EditorViewportPanel::OnWorldChange(const SharedPtr<World>& InNewWorld)
    {
